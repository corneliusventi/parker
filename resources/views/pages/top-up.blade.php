...
@if(!collect(auth()->user()->intros)->contains('topup-intro'))
    @push('css')
    ...
    @push('js')
        <script src="https://unpkg.com/driver.js/dist/driver.min.js"></script>
            <script>
                const topupDriver = new Driver({
                    onReset: (Element) => {
                        $.ajax({
                            data: {'intro': 'topup-intro'},
                            method: 'POST',
                ...
                topupDriver.defineSteps([
                    {
                        element: '#top-up-area',
                        popover: {
                            title: 'Top up area',
                            description: 'Fill your bank credentials & amount',
                            position: 'auto'
                        }
                    },
                ]);
